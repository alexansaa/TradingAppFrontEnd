...
export const msal = new PublicClientApplication({
  auth: {
    clientId,
    authority: `https://${tenantHost}/${tenantDomain}`, // NOTE: no /v2.0 here for SPA authority
    knownAuthorities,
    redirectUri,
...
export async function initMsal(): Promise<void> {
  console.log("AUTHORITY_BASE:", `https://${tenantHost}/${tenantDomain}`);             // https://login.smartpowerai.org/smartpowerai.onmicrosoft.com
